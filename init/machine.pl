...
placerPionsIA(InBoard, Cote, rouge, OutBoard) :-
  print('Initialisation des pions de la machine rouge'), nl,
...
placerPionsIA(InBoard, Cote, ocre, OutBoard) :-
  print('Initialisation des pions de la machine ocre'), nl,
...
placerPionIA(InBoard, Cote, TypePion, OutBoard) :-
  generatePos(Cote, Col, Lin),
