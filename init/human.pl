...
initPion(kr, Col, Lin) :-
  print('Kalista rouge'), nl,
  readInitPos(Col, Lin), !.

initPion(ko, Col, Lin) :-
  print('Kalista ocre'), nl,
  readInitPos(Col, Lin), !.

initPion(TypePion, Col, Lin) :-
  element(TypePion, [r1, r2, r3, r4, r5]),
  print('Sbire rouge'), nl,
  readInitPos(Col, Lin), !.

initPion(TypePion, Col, Lin) :-
  element(TypePion, [o1, o2, o3, o4, o5]),
  print('Sbire ocre'), nl,
  readInitPos(Col, Lin).
/*Lecture ligne et colonne*/
readInitPos(Col, Lin) :-
  print('Position (Ex. a1) ? '), read(Pos), nl,
  testInitPos(Pos, Col, Lin).

testInitPos(Pos, Col, Lin) :-
  parse(Pos, Col, Lin), Col \= 0, Lin \= 0, !.

testInitPos(Pos, Col, Lin) :-
  parse(Pos, 0, 0), print('Erreur de saisie de la position.'), nl,
  readInitPos(Col, Lin).
