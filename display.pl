...
afficherPlateau(Board, haut) :-
  print('   F     E     D     C     B     A   \n'),
  affichagePlateauHaut(Board, 0),
  print('_____________________________________\n'), nl.

afficherPlateau(Board, gauche) :-
  print('   1     2     3     4     5     6   \n'),
  affichagePlateauGauche(Board, 6),
  print('_____________________________________\n'), nl.

afficherPlateau(Board, droite) :-
  print('   6     5     4     3     2     1   \n'),
...
affichagePlateauHaut([T|Q], Lin) :-
  NLin is Lin + 1,
  affichagePlateauHaut(Q, NLin),
  print('_____________________________________\n'),
  print('|'), afficherLigneHaut(T),
  print(' '), print(NLin), nl,
  print('|     |     |     |     |     |     |\n').
...
affichagePlateauGauche(Board, Lin) :-
  print('_____________________________________\n'),
  print('| '), afficherLigneGauche(Board, Lin),
  afficherId(Lin), nl,
  NLin is Lin - 1,
  print('|     |     |     |     |     |     |\n'),
...
affichagePlateauDroite(Board, Lin) :-
  NLin is Lin + 1,
  print('_____________________________________\n'),
